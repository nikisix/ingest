...
public class gamesOfTheDay {
	...
	public static void main(String[] args) throws Exception {
		...
		final String help = "gamesOfTheDay takes the name of a file path to print out the new games from the games database\n" +
				"gamesOfTheDay <output_filePath> \n" +
				"gamesOfTheDay <ouput_filePath> <databaseUrl> <username> <password> <database.tablename>\n" +
				"defaults: \n" +
		...
		System.out.println("gamesOfTheDay running with the following parameters... " +n+
	...
	public static void writeNewGamesFile(MySqlConnection myCxn, String outfilepath, String tablename, String columnName) throws Exception{
		...
		String date = utils.getMySqlDate();
//		String query = "select GameId from gamesBuffer where ReleaseDate = '"+date+"'";
		String query = "select"+columnName+"from"+tablename+"where ReleaseDate = '"+date+"'";
